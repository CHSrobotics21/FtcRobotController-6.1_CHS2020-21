...
public class GlobalCoordinatePositionUpdateSample extends LinearOpMode {
    ...
    String verticalLeftEncoderName ="backleft" , verticalRightEncoderName = "frontleft", horizontalEncoderName = "frontright";
    ...
    public void runOpMode() throws InterruptedException {
        ...
        */
        ...
        while(opModeIsActive()){
            ...
            telemetry.addData("horizontal Encoder: ", globalPositionUpdate.normalEncoderWheelPosition);
            telemetry.addData("vertical right Encoder: ", globalPositionUpdate.verticalRightEncoderWheelPosition);
            telemetry.addData("vertical left Encoder: ", globalPositionUpdate.verticalLeftEncoderWheelPosition);
